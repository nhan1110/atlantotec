...
class GroupsController extends BackendController
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();   
        $this->_TABLE = "atlantotec_roles";
        $this->_ROUTE = "groups";
        $this->_URL   = route($this->_ROUTE_FIX.".".$this->_ROUTE); 
        $this->_DATA["_PAGETILE"] = "Manage groups";
    ...
    {   $table = [
        ...
        $this->_MODEL = \App\Models\Roles::where("is_sys","=",0)->paginate($this->_PAGINGNUMBER);
    ...
    public function rules($id)
    {
        ...
        $Models = \App\Models\Rules::GetModulesAllow($id,0);
