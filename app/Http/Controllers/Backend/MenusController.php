...
class MenusController extends BackendController
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();   
        $this->_TABLE = "atlantotec_menus";
        $this->_VIEW  = "menus/";
        $this->_ROUTE = "menus";
        $this->_URL   = route($this->_ROUTE_FIX.".".$this->_ROUTE);  
        $this->_DATA["_PAGETILE"] = "Manage menus";
    ...
    {   $table = [
            ...
            [
                ...
                'type'    => 'option',
                'options' => [
                    ['id' => 1 ,'name' => "Backend menu" ],
                    ['id' => 0 ,'name' => "Frontend menu" ]
                ],
                "option_key"     => "id",
                "option_value"   =>"name"
            ],
        ...
        if($menu == null) return Redirect()->back();
         $form = [
            ...
            "pid" => [
                ...
                "type"            => "select",
                "required"        => false,
                "options"         => \App\Models\MenuItems::where([
                    ["pid","=",0],
                    ["menu_id","=",$id]
                ]
                )->get()->toArray(),
            ...
            "is_login" => [
             ...
             "role_allow" => [
                "label"           => "Use by roles",
                "type"            => "multiple",
                "options"         => \App\Models\Roles::where("is_sys","=",$menu->is_sys)->get(),
                "options_value"   => "id",
                "options_label"   => "name",
                "required"        => false,
            ],
    ...
    public function storeitem (Request $request ,$id){
        $this->_TABLE = "atlantotec_menu_items";
