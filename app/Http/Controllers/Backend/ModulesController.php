...
class ModulesController extends BackendController
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();   
        $this->_TABLE = "atlantotec_modules";
        $this->_ROUTE = "modules";
        $this->_URL   = route($this->_ROUTE_FIX.".".$this->_ROUTE);  
        $this->_DATA["_PAGETILE"] = "Manage modules";
    ...
    {   
        ...
        $model = \App\Models\Modules::where("id","!=",0);
       
        if($request->type !== null){
            $model = $model->where("is_sys","=",$request->type);
            $this->_DATA["_ADNEWCONTEN"] ='<a class="btn m-btn--square  btn-success" href="'.route($this->_ROUTE_FIX.".".$this->_ROUTE . ".create") . "?type=".$request->type.'">Add New</a>';
        }   
        $this->_MODEL = $model->orderby("id","ASC")->paginate($this->_PAGINGNUMBER);
    ...
    public function create(Request $request)
    {
        $form = [
            ...
            "controller" => [
                ...
                "type"  => "text",
                "required" => false,
                "validate" => "unique:$this->_TABLE,controller"
            ] ,   
            "route" => [
                "label" =>  "Route",
                "type"  => "text",
            ...
            "is_sys" => [
                ...
                "options_label"   => "name",
                "required"        => true,
                "value"           =>  $request->type !== null ? $request->type : 1
            ],
            "status" => [
                "label"           => "Status",
                "type"            => "radio",
    ...
    public function edit($id)
    {
        ...
        $form = [
            ...
            "controller" => [
                ...
                "validate" => "unique:$this->_TABLE,controller,$item->id,id"
            ],
            "route" => [
                "label" =>  "Route",
                "type"  => "text",
