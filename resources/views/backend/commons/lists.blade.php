                                    ...
                                    foreach (@$models as $key_m => $value_m) {
                                        ...
                                        if(@$_CENTERACTION !== null){
                                           echo str_replace("%5BID%5D", @$value_m["id"], trim(@$_CENTERACTION));
                                            ...
                                            echo '<a href="'.$_ROUTE.'/edit/'.$value_m["id"].'">Edit</a> | <a id="delete-action" title="Xóa" href="javascript:;" data-href="'.$_ROUTE.'/destroy/'.$value_m["id"].'" onclick="return confirm(\'Do you want to delete this item?\');">Delete </a> '; 
                                        }
