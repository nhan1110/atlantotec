						...
						<div class="m-form__actions">
							<div class="row">
								<div class="col-12" style="text-align: right;">
									...
									<a class="btn btn-secondary" href="{{$_BACKURL}}">
										Back
									</a>
								</div>
							</div>
...
@endsection
@section("css_add")
	<link rel="stylesheet" type="text/css" href="{{asset('html/backend/css/menu.css')}}"> 
@stop
@section("js_add")
	<script src="{{asset('html/backend/js/jquery-ui/jquery-ui.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('html/backend/js/nestedSortable/jquery.mjs.nestedSortable.js')}}"></script>
	<script>
